package jain.piyush.happyplaceapp.activities.Adapter
...
import jain.piyush.happyplaceapp.activities.Activites.AddHappyPlace
import jain.piyush.happyplaceapp.activities.Activites.MainActivity
...
open class HappyPlacesAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            holder.itemView.findViewById<CircularImageView>(R.id.iv_place_image).setImageURI(Uri.parse(model.image))
